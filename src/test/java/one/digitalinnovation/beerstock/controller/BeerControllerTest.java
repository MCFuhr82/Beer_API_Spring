...
public class BeerControllerTest {
    ...
    @Test
    void quandoChamadoGETComNomeValidoEntaoStatusOkRetornado() throws Exception {
        //given
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void quandoChamadoGETComNomeInvalidoEntaoStatusNotFoundRetornado() throws Exception {
        //given
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void quandoChamadoGETComListaDeCervejaEntaoStatusOkRetornado() throws Exception {
        //given
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void quandoChamadoGETComListaDeCervejaVaziaEntaoStatusOkRetornado() throws Exception {
        //given
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void quandoChamadoDELETEComIdValidoEntaoNoContentStatusERetornado() throws Exception {
        // given
        BeerDTO beerDTO = BeerDTOBuilder.builder().build().toBeerDTO();
    ...
    @Test
    void quandoChamadoDELETEComIdInvalidoEntaoNotFoundStatusERetornado() throws Exception {
        //when
